...
class WishlistWow extends React.Component {
    ...
    ViewDetailProduct(val){
        ...
        console.log(val)
        Actions.DetailProductWishlistWowPage();
    }
    ...
    render() {
        console.log('ON WishlistWow', this.props.token)
        return (
...
export default  connect(mapStateToProps , mapDispatchToprops)(WishlistWow);
...
class CategorySkirtsScreenCustomer extends React.Component {
    ...
    componentDidMount() {
        try{
            axios.get(`http://161.246.4.226:8009/shop/product/?category=Skirt`)
        .then(res => {
            console.log('pass',res.data)
            this.setState({ dataSource : res.data});
        }),
        axios.get(`http://161.246.4.226:8009/shop/product/count/?category=Skirt`)
        .then(res => {
            console.log('pass',res.data)
...
export default  connect(null , mapDispatchToprops)(CategorySkirtsScreenCustomer);
...
class CategoryTopsScreenCustomer extends React.Component {
    ...
    componentDidMount() {
        try{
            axios.get(`http://10.66.4.239:8000/shop/product/?category=Top`)
        .then(res => {
            console.log('pass',res.data)
            this.setState({ dataSource : res.data});
        }),
        axios.get(`http://10.66.4.239:8000/shop/product/count/?category=Top`)
        .then(res => {
            console.log('pass',res.data)
    ...
    ViewDetailProduct(val){
        ...
        console.log(val)
        Actions.DetailCategoryTopsPageCustomer();
    }
...
export default  connect(null , mapDispatchToprops)(CategoryTopsScreenCustomer);
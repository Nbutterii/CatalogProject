...
class CategoryPantsScreenVisitor extends React.Component {
    ...
    ViewDetailProduct(val){
        ...
        console.log(val)
        Actions.DetailCategoryPantsPageVisitor();
    }
...
export default  connect(null , mapDispatchToprops)(CategoryPantsScreenVisitor);
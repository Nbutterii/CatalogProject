...
const ProductScreen = () => {
    ...
    <View style={styles.container}>
        ...
        <View  style={{position: 'absolute', left:0, right:0, top:0, height:70, backgroundColor:'#891C1C', flexDirection:'row', alignItems:'center', paddingHorizontal: 5}}>
            <TouchableOpacity>
        ...
        <ScrollView>
            <View style={{ marginLeft: 5, marginRight: 5, marginTop: 90 }}>
                <View header style={{borderBottomWidth:1,borderBottomColor:'#dee0e2'}}>
                    <Text style={{fontSize: 20, marginLeft: 10, marginBottom: 20}}>6 ITEMS</Text>
                </View>
                <RecommendedCardItem

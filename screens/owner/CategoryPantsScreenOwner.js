...
class CategoryPantsScreenOwner extends React.Component {
    ...
    ViewDetailProduct(val){
        ...
        console.log(val)
        Actions.DetailCategoryPantsPageOwner();
    }
...
export default  connect(null , mapDispatchToprops)(CategoryPantsScreenOwner);
...
class TopSkirtsScreen extends React.Component {
    ...
    componentDidMount() {
        try{
            axios.get(`http://161.246.4.226:8009/shop/product/topall/?category=Skirt`)
        .then(res => {
...
export default  connect(null , mapDispatchToprops)(TopSkirtsScreen);